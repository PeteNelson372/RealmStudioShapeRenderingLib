...
{
    public sealed class DrawnRectangle : MapComponent2D, IRectangularShape, IAlignable, IRotatable
    {
        ...
        public override void Render(SKCanvas canvas, FontManager? fontManager = null, SKPath? clipPath = null)
        {
            ...
            if (DrawRounded)
            {
                ...
                canvas.DrawRoundRect(roundRect, _rectanglePaint);
            }
            else
            {
        ...
        public override void RestoreState(IShapeState state)
        {
            ...
            RectangleColor = s.ComponentColor;
