...
namespace RealmStudioShapeRenderingLib
{
    public sealed class MapBuilder
    {
        ...
        public static RealmStudioMap CreateMap(string mapPath, string mapName, int width, int height, float mapAreaWidth, float mapAreaHeight, string mapAreaUnits)
        {
