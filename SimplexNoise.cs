namespace RealmStudioShapeRenderingLib
{
    public static class SimplexNoise
    {
        private static readonly int[] perm =
        {
            ...
            163,70,221,153,101,155,167,
            43,172,9,129,22,39,253,19,
            98,108,110,79,113,224,232,
            178,185,112,104,218,246,97,
            228,251,34,242,193,238,210,
            144,12,191,179,162,241,81,
        ...
        public static float Noise(float xin, float yin)
        {
            ...
            {
                t0 *= t0;
                n0 = t0 * t0 * Dot(grad3[permMod12[ii + perm[jj]]], x0, y0);
            }
            ...
            {
                t1 *= t1;
                n1 = t1 * t1 * Dot(grad3[permMod12[ii + i1 + perm[jj + j1]]], x1, y1);
            }
            ...
            {
                t2 *= t2;
                n2 = t2 * t2 * Dot(grad3[permMod12[ii + 1 + perm[jj + 1]]], x2, y2);
            }
