...
namespace RealmStudioShapeRenderingLib
{
    public sealed class DrawnPolygon : MapComponent2D, IDrawnMapComponent
    {
        ...
        private SKPaint _polygonPaint = new()
        {
        ...
        public override void Render(SKCanvas canvas, FontManager? fontManager = null)
        {
            ...
            {
                canvas.DrawLine(Points[0], Points[1], _polygonPaint);
            }
            else if (Points.Count > 2)
            {
                SKPath polyPath = Utilities.BuildClosedPath(Points);
                ...
                if (FillType != DrawingFillType.None)
                {
                    ...
                    canvas.DrawPath(polyPath, _fillPaint);
                }

                // draw the outline of the polygon
                canvas.DrawPath(polyPath, _polygonPaint);
            }
        }
