...
{
    public sealed class DrawnEllipse : MapComponent2D, IRectangularShape, IAlignable, IRotatable
    {
        ...
        private SKPaint _ellipsePaint = new()
        {
        ...
        public override void Render(SKCanvas canvas, FontManager? fontManager = null, SKPath? clipPath = null)
        {
            ...
            canvas.DrawOval(rect, _ellipsePaint);
        }
